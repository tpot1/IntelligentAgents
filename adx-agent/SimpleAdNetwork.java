...
public class SimpleAdNetwork extends Agent {
	...
	private Map<Integer, String> campaignWinners;
	...
	private void handleAdNetworkDailyNotification(
		...
		System.out.print(campaignWinners.entrySet().size());

		for (Map.Entry<Integer, String> entry : campaignWinners.entrySet())
		{
	...
	protected void simulationSetup() {
		...
		campaignWinners = new HashMap<Integer, String>();
