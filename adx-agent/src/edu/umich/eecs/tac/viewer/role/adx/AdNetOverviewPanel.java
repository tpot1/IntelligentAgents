 ...
 */
public class AdNetOverviewPanel extends JPanel {
	...
	private void initialize() {
		...
		advertiserCountTabPanel = new AdNetCountTabPanel(simulationPanel);
		...
		c.weighty = 1;
		c.fill = GridBagConstraints.BOTH;
		advertiserOverviewMetricsPanel = new AdNetOverviewMetricsPanel(
				simulationPanel);
