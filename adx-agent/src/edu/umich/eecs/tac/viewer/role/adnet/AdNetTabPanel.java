 ...
 */
public class AdNetTabPanel extends SimulationTabPanel {
	private JTabbedPane tabbedPane;

	private final Map<String, AdNetInfoTabPanel> advertiserInfoPanels;
	...
	public AdNetTabPanel(TACAASimulationPanel simulationPanel) {
		...
		participantNum = 0;
		advertiserInfoPanels = new HashMap<String, AdNetInfoTabPanel>();
	...
	private class ParticipantListener extends ViewAdaptor {
		...
		public void participant(int agent, int role, String name,
			...
			if (!advertiserInfoPanels.containsKey(name)
				...
				AdNetInfoTabPanel infoPanel = new AdNetInfoTabPanel(agent,
