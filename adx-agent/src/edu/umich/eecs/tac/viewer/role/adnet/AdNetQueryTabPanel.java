 ...
 */
public class AdNetQueryTabPanel extends JPanel {
	...
	public AdNetQueryTabPanel(int agent, String advertiser, Query query,
			ResultsPageModel resultsPageModel,
	...
	private void initialize() {
		...
		AverageRankingPanel averageRankingPanel = new AverageRankingPanel(
				resultsPageModel);
		...
		c.weighty = 1;
		c.fill = GridBagConstraints.BOTH;
		AdvertiserQueryInfoPanel queryInfoPanel = new AdvertiserQueryInfoPanel(
				agent, advertiser, query, simulationPanel);
		...
		AdvertiserQueryPositionPanel positionPanel = new AdvertiserQueryPositionPanel(
				agent, advertiser, query, simulationPanel, legendColor);
		...
		c.weighty = 3;
		c.fill = GridBagConstraints.BOTH;
		AdvertiserQueryCountPanel queryCountPanel = new AdvertiserQueryCountPanel(
				agent, advertiser, query, simulationPanel, legendColor);
		...
		c.weightx = 1;
		c.weighty = 1;
		AdvertiserQueryValuePanel queryValuePanel = new AdvertiserQueryValuePanel(
				agent, advertiser, query, simulationPanel);
